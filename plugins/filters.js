...
const array = ['Amal','caption','Mrng','alive','Di','Bro','amal','avan','converting','fayasser','Amalser','Allah','bg','help','Hii','odiko','oho','killadi','oo','Fuck','invite','photo','Hi','love','Owner','Group','list','man','Nanba','https','oii','Bot','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','Human','vannu','commands','Boss','vava','Myre','Lalitha','start','Adithhari','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam','tagall','Re entry','pass','patti','phaa','mone','look','bor','try','owner','luv','feel','romam','set','potte','no replay','bgm','vijay','poli']
array.map( async (a) => {
